        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(NamespaceAlertUserJunction::Id)
                            .uuid()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(NamespaceAlertUserJunction::UserId)
                            .uuid()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(NamespaceAlertUserJunction::NamespaceAlertId)
                            .uuid()
                            .not_null(),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(
                                NamespaceAlertUserJunction::Table,
                                NamespaceAlertUserJunction::UserId,
                            )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(
                                NamespaceAlertUserJunction::Table,
                                NamespaceAlertUserJunction::NamespaceAlertId,
                            )
