        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(UserNamespaceJunction::Id)
                            .uuid()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(UserNamespaceJunction::UserId)
                            .uuid()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(UserNamespaceJunction::NamespaceId)
                            .uuid()
                            .not_null(),
                    )
                    .foreign_key(
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(
                                UserNamespaceJunction::Table,
                                UserNamespaceJunction::NamespaceId,
                            )
                    ...
                    .col(
                        ColumnDef::new(UserNamespaceJunction::Role)
                            .string()
                            .not_null(),
                    )
                    .to_owned(),
