...
use shared_types::namespace_alert_dtos::{
    CreateNamespaceAlertRequestDTO, NamespaceAlertSubscriptionRequestDTO,
...
impl NamespaceAlertHandler {
    pub async fn create_namespace_alert(
        ...
        match namespace_alert_services
            .create_namespace_alert(new_namespace_alert)
            .await
        {
    ...
    pub async fn delete_namespace_alert(
        namespace_alert_services: web::Data<Arc<NamespaceAlertsService>>,
        namespace_alert_id: web::Path<Uuid>,
    ) -> Result<HttpResponse, ServerError> {
        let namespace_alert_id = namespace_alert_id.into_inner();
        match namespace_alert_services
            .delete_namespace_alert(namespace_alert_id)
            .await
        {
    ...
    pub async fn get_namespace_alerts_by_namespace_id(
        ...
        match namespace_alert_services
            .get_namespace_alerts_by_namespace_id(namespace_id)
            .await
        {
    ...
    pub async fn get_namespace_alerts_by_user_id(
        ...
        match namespace_alert_services
            .get_namespace_alerts_by_user_id(user_id)
            .await
        {
            Ok(alerts) => Ok(HttpResponse::Ok().json(alerts)),
            Err(err) => Err(err),
    ...
    pub async fn subscribe_user_to_namespace_alert(
        ...
        match namespace_alert_services
            .subscribe_user_to_namespace_alert(subscription)
            .await
        {
    ...
    pub async fn update_namespace_alert(
        ...
        updated_alert: web::Json<UpdateNamespaceAlertRequestDTO>,
    ) -> Result<HttpResponse, ServerError> {
        let updated_alert = updated_alert.into_inner();

        match namespace_alert_services
            .update_namespace_alert(alert_id.into_inner(), updated_alert)
            .await
        {
            Ok(_) => Ok(HttpResponse::Ok().finish()),
            Err(err) => Err(err),
    ...
    pub async fn get_subscribed_users_by_namespace_alert_id(
        ...
        match namespace_alert_services
            .get_subscribed_users_by_namespace_alert_id(alert_id)
            .await
        {
